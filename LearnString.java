...
//		System.out.println(substring2);
		  ...
		  String text = "testleaf"; String replace = text.replace("t", "");
		  System.out.println(replace);
		  
		  String text1 = "Estb 1905"; String replaceAll = text1.replaceAll("[^A-Za-z]",
		  ""); System.out.println(replaceAll); String replaceAll2 =
		  text1.replaceAll("\\D", ""); System.out.println(replaceAll2);
